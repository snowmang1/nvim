...
_G.packer_plugins = {
  ale = {
    loaded = true,
    path = "/Users/evandrake/.local/share/nvim/site/pack/packer/start/ale",
  ...
  ["lualine.nvim"] = {
    loaded = true,
    path = "/Users/evandrake/.local/share/nvim/site/pack/packer/start/lualine.nvim",
  ...
  ["vim-hcl"] = {
    loaded = true,
    path = "/Users/evandrake/.local/share/nvim/site/pack/packer/start/vim-hcl",
